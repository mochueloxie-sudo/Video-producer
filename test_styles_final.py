...
for ct in types:
  ...
  print(f"  Body: {params.get('body_size')} font: {params.get('body_font', 'N/A')[:30]}")
  print(f"  Spacing: {params.get('spacing')}")
  print(f"  Decoration: {params.get('decoration_count')}")
  print(f"  Code styling: {params.get('has_code_styling')}")
  print(f"  Content density: {params.get('content_density')}")
